...
var require_jquery = __commonJS({
  "node_modules/jquery/dist/jquery.js"(exports, module) {
    (function(global, factory) {
      ...
      var version2 = "3.7.1", rhtmlSuffix = /HTML$/i, jQuery2 = function(selector, context2) {
      ...
      (function() {
        ...
        function find(selector, context2, results, seed) {
          var m2, i2, elem, nid, match, groups, newSelector, newContext = context2 && context2.ownerDocument, nodeType = context2 ? context2.nodeType : 9;
          results = results || [];
              ...
              if (nodeType !== 11 && (match = rquickExpr2.exec(selector))) {
                if (m2 = match[1]) {
                  if (nodeType === 9) {
                    ...
                    if (newContext && (elem = newContext.getElementById(m2)) && find.contains(context2, elem) && elem.id === m2) {
                      push2.call(results, elem);
                      return results;
                    }
                  }
                  ...
                  return results;
                } else if ((m2 = match[3]) && context2.getElementsByClassName) {
                  push2.apply(results, context2.getElementsByClassName(m2));
                  return results;
                }
              }
        ...
        find.contains = function(context2, elem) {
          ...
          return jQuery2.contains(context2, elem);
        };
      ...
      jQuery2.proxy = function(fn2, context2) {
        var tmp, args, proxy;
...
var Dropdown = class _Dropdown extends BaseComponent {
  ...
  static clearMenus(event) {
    ...
    for (const toggle of openToggles) {
      const context2 = _Dropdown.getInstance(toggle);
    ...
    for (const trigger of triggers) {
      if (trigger === "click") {
        EventHandler.on(this._element, this.constructor.eventName(EVENT_CLICK$1), this._config.selector, (event) => {
          ...
          context2._activeTrigger[TRIGGER_CLICK] = !(context2._isShown() && context2._activeTrigger[TRIGGER_CLICK]);
          context2.toggle();
        });
...
var BindingObserver = class {
  constructor(context2, delegate2) {
    this.context = context2;
    this.delegate = delegate2;
...
var context = __require.context(".", true, /_controller\.js$/);
...
var DatasetController = class {
  ...
  _resolveElementOptions(elementType, mode = "default", index2) {
    ...
    const context2 = () => this.getContext(index2, active, mode);
